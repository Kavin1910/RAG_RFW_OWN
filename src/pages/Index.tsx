...
import { BarChart3, Shield, Zap, TrendingUp, Users } from "lucide-react";
        ...
        <header className="border-b bg-card/50 backdrop-blur-sm sticky top-0 z-50">
          <div className="container mx-auto px-4 py-4 flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <img 
                src="/lovable-uploads/6d833920-68da-4817-b9d3-11afc6f13984.png" 
                alt="SoftWorks Technologies" 
                className="h-8 w-auto"
              />
              <h1 className="text-2xl font-bold gradient-hero bg-clip-text text-transparent">SalesBot AI</h1>
            </div>
